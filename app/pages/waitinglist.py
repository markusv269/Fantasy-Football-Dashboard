    ...
    return layout(
        rx.vstack(
            rx.vstack(
                ...
                rx.text(
                    "Die Warteliste für neue Dynasty Ligen ist geschlossen. Für weitere Ligen besuche den Stoned Lack Discord-Kanal. "
                    "Allen Teilnehmern viel Erfolg in den neuen Dynasty-Ligen von Stoned Lack!",
